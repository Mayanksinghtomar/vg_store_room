...
public class Foot_wear2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()) {
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("select * from Foot_Wear");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextField1.getText().isEmpty() && jTextField5.getText().isEmpty() && jTextField4.getText().isEmpty()
            ...
            try {
                ...
                String str2 = "INSERT INTO Foot_Wear VALUES('" + (itemname) + "','" + (itemsize) + "','" + (itemquant) + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Foot_wear2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
