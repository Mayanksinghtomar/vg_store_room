...
public class IssueClothes extends javax.swing.JFrame {
    ...
    public IssueClothes() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("Select distinct Item_Name From clothes");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("Select * From clothes where Item_Name ='" + jComboBox1.getSelectedItem().toString() + "'");
            // Iterate through the result and display on screen
            while (rs.next()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ( jTextField1.getText().isEmpty() && jTextField2.getText().isEmpty()
                && jTextField3.getText().isEmpty() && (a == -1 || a == 0)) {
            ...
            if ((qu > qua) || (qu == qua)) {
                ...
                try {
                    ...
                    stmt.executeUpdate("Update Clothes Set Quantity='" + quan + "' where Item_Name ='" + jComboBox1.getSelectedItem().toString() + "' "
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        try {
            ...
            com.mysql.jdbc.Connection con = (com.mysql.jdbc.Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Store_house", "root", "123");
            com.mysql.jdbc.Statement stmt = (com.mysql.jdbc.Statement) con.createStatement();
            ResultSet rs = stmt.executeQuery("Select * From Clothes Where  Item_Name ='" + jComboBox1.getSelectedItem().toString() + "' AND  Size ='" + jComboBox2.getSelectedItem().toString() + "'");
            // Iterate through the result and display on screen
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssueClothes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
