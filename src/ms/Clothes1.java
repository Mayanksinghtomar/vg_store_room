...
public class Clothes1 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextField1.getText().isEmpty() && jTextField3.getText().isEmpty() && jTextField2.getText().isEmpty()
            ...
            try {
                ...
                stmt2.executeUpdate(" Update Clothes SET Quantity=   Quantity + '" + itemquant + "' Where  Item_Name ='" + jComboBox1.getSelectedItem().toString() + "' AND  Size ='" + jComboBox2.getSelectedItem().toString() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clothes1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
