...
public class Stationery1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jComboBox1.getSelectedIndex() == 0) {
            ...
            new Stationery2().setVisible(true);
        } else {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextField1.getText().isEmpty() && jTextField3.getText().isEmpty() && jTextField2.getText().isEmpty()
            ...
            try {
                ...
                stmt2.executeUpdate(" Update stationary SET Quantity=   Quantity + '" + itemquant + "' Where  Item_Name ='" + jComboBox1.getSelectedItem().toString() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stationery1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
