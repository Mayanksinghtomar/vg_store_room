...
public class IssueStationery extends javax.swing.JFrame {
    ...
    public IssueStationery() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("Select distinct * From stationary");
        ...
        if (jTextField1.getText().isEmpty() && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()) {
            ...
            if ((qu > qua) || (qu == qua)) {
                ...
                try {
                    ...
                    stmt.executeUpdate("Update stationary Set Quantity='" + quan + "' where Item_Name ='" + jComboBox1.getSelectedItem().toString() + "'");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Store_house", "root", "123");
            Statement stmt = (Statement) con.createStatement();
            ResultSet rs = stmt.executeQuery("Select * From stationary where Item_Name ='" + jComboBox1.getSelectedItem().toString() + "'");
            // Iterate through the result and display on screen
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IssueStationery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
