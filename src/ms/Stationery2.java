...
import java.sql.*;
public class Stationery2 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField2.getText().isEmpty()) {
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("select * from stationary");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTextField1.getText().isEmpty() && jTextField4.getText().isEmpty() && jTextField3.getText().isEmpty() && jTextField5.getText().isEmpty()) {
            ...
            try {
                ...
                String str2 = "INSERT INTO stationary VALUES('" + (itemname) + "','" + (itemquant) + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stationery2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
